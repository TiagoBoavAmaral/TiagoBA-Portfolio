...
const AcademicsPage = () => {
  const firstSemesterCourses = [
    ...
    {
      name: "Desenvolvimento de Interface Web",
      hours: 80,
      modality: "Híbrido",
      grade: 96,
    },
    ...
    {
      name: "Projeto Interdisciplinar: Aplicações Web",
      hours: 50,
      modality: "Presencial",
      grade: 98,
    },
  ...
  const secondSemesterCourses = [
    ...
    {
      name: "Filosofia: Razão e Modernidade",
      hours: 40,
      modality: "Presencial",
      grade: 80,
    },
    {
      name: "Laboratório de Programação Modular",
      hours: 40,
      modality: "Presencial",
      grade: 89,
    },
    ...
    {
      name: "Projeto Interdisciplinar: Aplicações de Processos de Negócio",
      hours: 50,
      modality: "Presencial",
      grade: 93,
    },
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="text-center p-4 bg-muted/30 rounded-lg">
                ...
                <p className="text-foreground text-sm">
                  {firstSemesterStats.completedHours}/
                  {firstSemesterStats.totalHours}
                </p>
              </div>
              <div className="text-center p-4 bg-muted/30 rounded-lg">
                <p className="text-orange-400 font-bold text-lg">Média</p>
                <p className="text-foreground text-sm">
                  {firstSemesterStats.gradeAvg}/100
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6 bg-card/50 backdrop-blur-sm border-border/30">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              <div className="text-center p-4 bg-muted/30 rounded-lg">
                <p className="text-orange-400 font-bold text-lg">Horas</p>
                <p className="text-foreground text-sm">
                  {secondSemesterStats.completedHours}/
                  {secondSemesterStats.totalHours}
                </p>
              </div>
              <div className="text-center p-4 bg-muted/30 rounded-lg">
                <p className="text-orange-400 font-bold text-lg">Média</p>
                <p className="text-foreground text-sm">
                  {secondSemesterStats.gradeAvg}/100
                </p>
              </div>
            </div>
          </Card>
